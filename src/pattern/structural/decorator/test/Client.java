package pattern.structural.decorator.test;

import pattern.structural.decorator.adddeco.CrossingDecorator;
import pattern.structural.decorator.adddeco.LaneDecorator;
import pattern.structural.decorator.adddeco.TrafficDecorator;
import pattern.structural.decorator.component.Display;
import pattern.structural.decorator.component.RoadDisplay;
/* 데코레이터 패턴
